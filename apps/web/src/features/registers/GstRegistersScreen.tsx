...
import { TallyPrimeExportPanel } from "../integrations/TallyPrimeExport";
...
export function GstRegistersScreen({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Tally Export */}
      {client && (kind === "purchase" || kind === "sales") && (
        <TallyPrimeExportPanel
          clientId={clientId}
          clientGstin={client.gstin}
          fy={fy}
          registerKind={kind === "sales" ? "sales" : "purchase"}
